  ...
  return (
    <header className="sticky top-0 z-50 border-b border-white/70 bg-white/82 shadow-sm backdrop-blur-xl">
      <nav className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-5 py-4 sm:px-8">
        <NavLink to="/" className="flex min-w-0 items-center gap-3 font-display text-base font-bold tracking-normal text-ink">
          <span className="relative grid h-10 w-10 shrink-0 place-items-center rounded-full bg-leaf-100 shadow-inner">
        ...
        <div className="flex shrink-0 items-center gap-1 rounded-full border border-leaf-100 bg-white p-1 text-sm font-semibold text-slate-600 shadow-sm">
